...
|-----------|---------------|
| **Programming** | Python, C, C++, Java, JavaScript (React, Angular, Next.js) |
| **Cloud & DevOps** | AWS, Azure, GCP, Jenkins, Docker, Kubernetes, GitHub Actions |
| **Databases** | PostgreSQL, MySQL |
| **Automation & Testing** | Selenium, JUnit, Serenity |
| **Other Tools** | Linux, Canva, Figma, Ubuntu, jQuery |
